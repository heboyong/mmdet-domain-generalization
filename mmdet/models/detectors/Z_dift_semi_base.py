...
class SemiBaseDiftDetector(BaseDetector):
    ...
    def loss_by_gt_instances_dift(self, batch_inputs: Tensor,
                                  batch_data_samples: SampleList) -> dict:
        """Calculate losses from a batch of inputs and ground-truth data
        samples.
        ...
        losses = self.dift_detector.loss(batch_inputs, batch_data_samples)
        sup_weight = self.semi_train_cfg.get('sup_weight', 1.)
        return rename_loss_dict('sup_dift_', reweight_loss_dict(losses, sup_weight))
    ...
    def _forward(self, batch_inputs: Tensor,
        ...
        elif self.semi_test_cfg.get('forward_on', 'teacher') == 'dift_detector':
            return self.dift_detector(batch_inputs, batch_data_samples, mode='tensor')
    ...
    def extract_feat(self, batch_inputs: Tensor) -> Tuple[Tensor]:
        ...
        elif self.semi_test_cfg.get('extract_feat_on', 'teacher') == 'dift_detector':
            return self.dift_detector.extract_feat(batch_inputs)
