...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        ann_file='rainy_cityscapes/train.json',
        data_prefix=dict(img='rainy_cityscapes/JPEGImages/'),
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        metainfo=dict(classes=classes),
        ann_file='rainy_cityscapes/test.json',
        data_prefix=dict(img='rainy_cityscapes/JPEGImages/'),
        test_mode=True,
        filter_cfg=dict(filter_empty_gt=True),
...
val_evaluator = dict(
    type='CocoMetric',
    ann_file=data_root + 'rainy_cityscapes/test.json',
    metric='bbox',
    format_only=False)
