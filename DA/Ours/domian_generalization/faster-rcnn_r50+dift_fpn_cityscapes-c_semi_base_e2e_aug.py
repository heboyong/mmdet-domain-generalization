_base_ = [
    '../../_base_/models/semi_faster_rcnn_r50+dift_fpn.py',
    '../../_base_/da_setting/semi_e2e_20k_0.1backbone.py',
    '../../_base_/datasets/domain_generalization/semi_cityscapes-c_aug.py'
]
...
detector.semi_train_cfg.student_pretrained = 'work_dirs_all/faster-rcnn_r101_fpn_cityscapes_source/iter_20000.pth'
