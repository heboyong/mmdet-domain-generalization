_base_ = [
    ...
    '../../_base_/datasets/voc/semi_voc_aug.py'
]
...
detector.dift_model.config = 'DA/Ours/voc/faster-rcnn_dift_fpn_voc_source.py'
detector.dift_model.pretrained_model = 'work_dirs_dift/faster-rcnn_dift_fpn_voc_source/iter_20000.pth'
