_base_ = [
    ...
    '../../_base_/datasets/cityscapes/semi_cityscapes_aug.py'
]
...
detector.dift_model.config = 'DA/Ours/cityscapes/faster-rcnn_dift_fpn_cityscapes_source.py'
detector.dift_model.pretrained_model = 'work_dirs_dift/faster-rcnn_dift_fpn_cityscapes_source/iter_20000.pth'
