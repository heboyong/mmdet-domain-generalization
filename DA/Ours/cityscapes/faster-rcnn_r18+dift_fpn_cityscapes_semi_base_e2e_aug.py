_base_ = [
    '../../_base_/models/semi_faster_rcnn_r18+dift_fpn.py',
...
detector.semi_train_cfg.student_pretrained = 'work_dirs/faster-rcnn_r18_fpn_cityscapes_source/iter_20000.pth'
