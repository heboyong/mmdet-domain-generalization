_base_ = [
    '../../_base_/models/semi_faster_rcnn_vit+dift_fpn.py',
...
detector.semi_train_cfg.student_pretrained = 'work_dirs_all/faster-rcnn_vit_fpn_cityscapes_source/iter_20000.pth'
