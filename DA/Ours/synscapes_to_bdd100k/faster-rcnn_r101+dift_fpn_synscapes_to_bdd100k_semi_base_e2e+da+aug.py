_base_ = [
    ...
    '../../_base_/datasets/synscapes_to_bdd100k/semi_synscapes_to_bdd100k.py'
]
...
detector.dift_model.config = 'work_dirs_all/faster-rcnn_dift_fpn_synscapes_to_bdd100k_source/faster-rcnn_dift_fpn_synscapes_to_bdd100k_source.py'
detector.dift_model.pretrained_model = 'work_dirs_all/faster-rcnn_dift_fpn_synscapes_to_bdd100k_source/iter_20000.pth'
