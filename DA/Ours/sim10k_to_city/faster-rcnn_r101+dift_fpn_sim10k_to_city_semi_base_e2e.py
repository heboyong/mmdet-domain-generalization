_base_ = [
    ...
    '../../_base_/datasets/sim10k_to_city/semi_sim10k_to_city.py'
]
...
detector.dift_model.config = 'work_dirs_all/faster-rcnn_dift_fpn_sim10k_to_city_source/faster-rcnn_dift_fpn_sim10k_to_city_source.py'
detector.dift_model.pretrained_model = 'work_dirs_all/faster-rcnn_dift_fpn_sim10k_to_city_source/iter_20000.pth'
