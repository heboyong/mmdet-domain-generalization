...
def parser_arguments():
    ...
    arg_parser.add_argument("--src_path", type=str,
                            ...
                            default='/home/kemove/disk/data/det/WoodScapes/instance_annotations')
    arg_parser.add_argument("--dst_path", type=str,
                            help="box_2d annotations directory", default='result')
    arg_parser.add_argument("--box_2d_class_mapping", type=str,
                            default='/home/kemove/disk/project/cv_tools/woodscape/scripts/configs/box_2d_mapping_8_classes.json',
                            help="box_2d_mapping_x_classes.json")
    arg_parser.add_argument("--instance_class_mapping", type=str,
                            default='/home/kemove/disk/project/cv_tools/woodscape/scripts/mappers/class_names.json',
                            help="class_names.json")
    arg_parser.add_argument("--rgb_image_path", type=str, nargs="?",
                            default='/home/kemove/disk/data/det/WoodScapes/rgb_images',
